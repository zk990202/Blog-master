        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="http://localhost/blog-master_1/public/alllist" class="navbar-brand"><b>Blog List</b></a>
        ...
        <div class="container">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Update my blog</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{url('/admin/user')}}{{'/'.$id}}" method="post">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <br>
                            <input type="text" style="width: 700px" name="name" value="{{$user[0]->name}}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Email</label>
                            <br>
                            <input type="text" style="width: 700px" name="email" value="{{$user[0]->email}}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Password</label>
                            <br>
                            <input type="password" style="width: 700px" name="password">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Authority</label>
                            <br>
                            <input type="text" style="width: 700px" name="is_admin" value="{{$user[0]->is_admin}}">
                        </div>
                    </div>
                    <!-- /.box-body -->
