        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="{{url('/admin')}}" class="navbar-brand"><b>Admin</b></a>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-widget widget-user-2">
                ...
                <div class="widget-user-header bg-yellow">
                    <!-- /.widget-user-image -->
                    <h3 class="widget-user-username">Start to Admin!</h3>
                </div>
                @foreach($view as $views)
                    <div class="box-footer no-padding">
                        <ul class="nav nav-stacked">
                            ----name:{{$views->name}} <br>----email:{{$views->email}} <br>
                            ----is_admin:{{$views->is_admin}}<br>
                            <button onclick="{location.href='{{url('/admin/user/update')}}{{'/'.$views->id}}'}" type="button" class="btn btn-default btn-xs">
                                Update</button>
                            <button onclick="{if(confirm('Are you sure to delete?'))location.href='{{url('/admin/user/delete')}}{{'/'.$views->id}}'}" type="button" class="btn btn-default btn-xs">
                                Delete</button>
                        </ul>
